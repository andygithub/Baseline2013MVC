...
namespace EFCachingProvider
{
    ...
    public class EFCachingCommandDefinition : DbCommandDefinitionWrapper
    {
        ...
        //TODO update this list to include any oracle functions
        ...
        public bool IsCacheable()
        {
            if (!(this.CommandTree is DbQueryCommandTree))
            {
                ...
                System.Diagnostics.Debug.WriteLine("NotCachedable DbQueryCommandTree");
                return false;
            }

            if (this.functionsUsed.Any(f => IsNonDeterministicFunction(f)))
            {
                System.Diagnostics.Debug.WriteLine("NotCachedable IsNonDeterministicFunction");
                return false;
            }
