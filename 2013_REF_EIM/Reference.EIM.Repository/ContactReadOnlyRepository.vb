...
Public Class ContactReadOnlyRepository
    ...
    Public Function NewlyCreated() As IList(Of Domain.Contact) Implements IContactRepository.NewlyCreated
        ...
        Return GetQuery(Of Domain.Contact)().Where(Function(c) c.AddDate >= lastMonth).AsNoTracking.ToList()
    End Function
    ...
    Public Function FindByName(firstname As String, lastname As String) As Domain.Contact Implements IContactRepository.FindByName
        Return GetQuery(Of Domain.Contact)().Where(Function(c) c.FirstName = firstname AndAlso c.LastName = lastname).AsNoTracking.FirstOrDefault()
    End Function
End Class
